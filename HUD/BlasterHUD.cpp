...
//-------------------------------------------------------------------------------------------------------------------------
void ABlasterHUD::AddAnnonucement()
{
	APlayerController *PlayerController = GetOwningPlayerController();
	if (PlayerController && AnnonucementClass)
	{
		Annonucement = CreateWidget<UAnnonucement>(PlayerController,AnnonucementClass);
		Annonucement->AddToViewport();
	}

}
//-------------------------------------------------------------------------------------------------------------------------
void ABlasterHUD::AddElimAnnonucement(FString AttackerName, FString VictimName)
{
