...
void AShotgun::FireShotgun(const TArray<FVector_NetQuantize>& HitTargets)
{
	...
	if(MuzzleFlashSocket)
	{
		...
		//Map hit character to number of times hit
		...
		//Calculate Head shot damage by multiplying times hit x headshot damage - store in DamageMap
			...
			if(DamagePair.Key && InstigatorController)
			{
				...
				if(HasAuthority() && bCauseAuthDamage)
				{
					UGameplayStatics::ApplyDamage(
						DamagePair.Key,//Characters that were hit
...
//-------------------------------------------------------------------------------------------------------------------------
void AShotgun::ShotgunEndPointWithScatter(const FVector& HitTarget, TArray<FVector_NetQuantize>& HitTargets)
{
	const USkeletalMeshSocket *MuzzleFlashSocket = GetWeaponMesh()->GetSocketByName("MuzzleFlash");
