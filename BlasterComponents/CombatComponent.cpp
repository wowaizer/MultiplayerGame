...
#include "Bluster/Character/BlasterAnimInstance.h"
#include "Camera/CameraComponent.h"
#include "TimerManager.h"
#include "Sound/SoundCue.h"
#include "Bluster/Weapon/Projectile.h"
#include "Bluster/Weapon/Shotgun.h"
...
{
	CarriedAmmoMap.Emplace(EWeaponType::EWT_AssaultRifle,StatrtingARAmmo);
...
void UCombatComponent::FireProjectileWeapon()
{
	...
	{
		HitTarget = EquippedWeapon->bUseScatter ? EquippedWeapon->EndPointWithScatter(HitTarget) : HitTarget;
		if(!Character->HasAuthority())
		{
			LocalFire(HitTarget);
		}
...
void UCombatComponent::FireShotgun()
{
	...
	if (Shotgun && Character)
	{
		...
		Shotgun->ShotgunEndPointWithScatter(HitTarget,HitTargets);
...
void UCombatComponent::LocalFire(const FVector_NetQuantize& TraceHitTarget)
{
	...
	{
		Character->PlayFireMonatage(bAiming);
...
void UCombatComponent::FinishSwapAttachWeapons()
{
	...
	EquippedWeapon->SetHUDAmmo();
	UpdateCarriedAmmo();
	if (Character->HasAuthority() && Character->IsLocallyControlled()) PlayEquipWeaponSound(EquippedWeapon);
	ReloadEmptyWeapon();
...
{
	//Jump to the ShotgunEnd montage section
